...
define(
    ...
    function (ko, $, Component, quote, fullScreenLoader, setPaymentInformationAction, placeOrder) {
        ...
        return Component.extend({
            ...
            getCode: function() {
                return 'ambient_payfort_installments';
            },
            isActive: function() {
                return true;
            },
            ...
            getInstructions: function() {
                return window.checkoutConfig.payment.ambientPayfort.ambient_payfort_installments.instructions;
            },
            // Overwrite properties / functions
            redirectAfterPlaceOrder: false,
            
            afterPlaceOrder : function() {
                $.mage.redirect(window.checkoutConfig.payment.ambientPayfort.ambient_payfort_installments.redirectUrl);
            },

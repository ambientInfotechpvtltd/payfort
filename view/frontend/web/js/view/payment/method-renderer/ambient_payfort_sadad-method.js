    ...
    function (ko, $, Component, quote, fullScreenLoader, setPaymentInformationAction, placeOrder) {
        ...
        return Component.extend({
            ...
            getInstructions: function() {
                return window.checkoutConfig.payment.ambientPayfort.ambient_payfort_sadad.instructions;
            },
            // Overwrite properties / functions
            redirectAfterPlaceOrder: false,

            afterPlaceOrder : function() {
                $.mage.redirect(window.checkoutConfig.payment.ambientPayfort.ambient_payfort_sadad.redirectUrl);
            },

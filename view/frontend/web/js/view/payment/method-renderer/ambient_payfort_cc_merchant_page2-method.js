...
define(
    ...
    function (ko, $, Component, quote, _, fullScreenLoader, setPaymentInformationAction, placeOrderAction, additionalValidators, messageList, $t) {
        ...
        return Component.extend({
            ...
            defaults: {
                template: 'Ambient_Payfort/payment/ambient-form-merchant-page2',
                isCcFormShown: true,
            },

            getCode: function() {
                return 'ambient_payfort_cc';
            },
            ...
            getInstructions: function() {
                return window.checkoutConfig.payment.ambientPayfort.ambient_payfort_cc.instructions;
            },
            ...
            afterPlaceOrder: function() {
                var cardInfo = {
                        ...
                        expirationYear: this.creditCardExpYear(),
                        cvv: this.creditCardVerificationNumber(),
                        holderName: $('#ambient_payfort_cc_cc_holder_name').val()
                    };
                ...
                $.ajax({
                    url: window.checkoutConfig.payment.ambientPayfort.ambient_payfort_cc.ajaxUrl,
                    type: 'get',
                    context: this,
                    dataType: 'json',
                    success: function(response) {
                        var preparedData,
                            msg;
                        if (response.success) {
                            var formId = 'frm_ambient_payfort_payment';
